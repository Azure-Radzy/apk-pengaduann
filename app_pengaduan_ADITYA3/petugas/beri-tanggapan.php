...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        echo "<script>alert('Tanggapan berhasil disimpan.'); window.location.assign('petugas.php');</script>";
    } else {
        echo "<script>alert('Gagal menyimpan tanggapan.'); window.location.assign('petugas.php?id=$id');</script>";
    }
    exit;
}
?>
